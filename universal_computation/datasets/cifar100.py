    ...
    def __init__(self, batch_size, patch_size=None, data_aug=True, *args, **kwargs):
        ...
        if data_aug:
            transform = transforms.Compose([
                ...
                transforms.Normalize((0.5071, 0.4865, 0.4409), (0.2023, 0.1994, 0.2010)),
            ])
        else:
            transform = transforms.Compose([
                transforms.ToTensor(),
        ...
        self.d_train = DataLoader(
            torchvision.datasets.CIFAR100('data/cifar', download=True, train=True, transform=transform),
            batch_size=batch_size, drop_last=True, shuffle=True,
        )
        self.d_test = DataLoader(
            torchvision.datasets.CIFAR100('data/cifar', download=True, train=False, transform=val_transform),
            batch_size=batch_size, drop_last=True, shuffle=True,
        )
